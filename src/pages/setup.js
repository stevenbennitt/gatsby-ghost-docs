...
const SetupPage = ({ data, location }) => {
    ...
    const title = `How To Install: Setup & Configuration - Open Source Publishing`
    const description = `All the tools you need to get started with 👉Self-hosted install & setup, local install guide for development, contribution guidelines & premium hosted services!`
